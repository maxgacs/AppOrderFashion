...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnRegisterCus= findViewById<TextView>(R.id.btnRegisterCus)
        btnRegisterCus.setOnClickListener{
            val intent = Intent(applicationContext, RegisterActivityCus::class.java)
            startActivity(intent)
            finish()
        }
        ...
        btnLogin.setOnClickListener {
            ...
            val formBody: RequestBody = FormBody.Builder()
                    .add("memberUsername", editUsername.text.toString())
                    .add("memberPassword", editPassword.text.toString())
                    .build()
            ...
            try {
                ...
                if (response.isSuccessful) {
                    try {
                        ...
                        val userID = obj["memberID"].toString()
                        val username = obj["memberUsername"].toString()
    ...
    override fun onResume() {
        val sharedPrefer: SharedPreferences =
                getSharedPreferences(appPreference, Context.MODE_PRIVATE)
        val userID = sharedPrefer?.getString(userIdPreference, 0.toString())

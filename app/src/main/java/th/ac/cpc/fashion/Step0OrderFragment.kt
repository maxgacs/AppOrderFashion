...
class Step0OrderFragment : Fragment() {
    ...
    var txtTotalPrice2: TextView? = null
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_step0_order, container, false)
        ...
        txtTotalPrice2 = root.findViewById(R.id.txtTotalPrice2)
        ...
        permission()
            ...
            btnComfirm?.setOnClickListener{
                if (NullempID == "0"){
                    ...
                    AddSalary(bundle?.get("orderID").toString())
                    ...
                    updateOrderComfirmStep1(bundle?.get("orderID").toString())
                    AddSalaryWaiting(bundle?.get("orderID").toString())
                    Toast.makeText(
    ...
    {
        var url: String = getString(R.string.root_url) + getString(R.string.viewDepositOrderID_url) + orderID
        val okHttpClient = OkHttpClient()
        val request: Request = Request.Builder()
                .url(url)
                .get()
                ...
                try {
                    ...
                    if (data.length() > 0) {
                        ...
                        var imgUrl = getString(R.string.root_url) +
                                getString(R.string.deposit_image_url) +
                                data.getString("depositSlip")
            ...
            if (response.isSuccessful) {
                try {
                    ...
                    if (data.length() > 0) {
                        ...
                        txtTotalPrice2?.text = data.getString("HalfPrice")

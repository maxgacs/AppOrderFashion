...
class EditProfileAdminFragment : Fragment() {
    ...
    var editBirthday: TextView? = null
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_edit_profile_admin, container, false)
        ...
        val callback = requireActivity().onBackPressedDispatcher.addCallback(this) {
            ...
            fragmentTransaction.replace(R.id.nav_host_fragment,ProfileAdminFragment())
        ...
        editBirthday = root.findViewById(R.id.editBirthday)
        ...
        val date = DatePickerDialog.OnDateSetListener { view, year, monthOfYear, dayOfMonth -> // TODO Auto-generated method stub
            ...
            editBirthday?.text = sdf.format(myCalendar.time)
        }
    ...
    private fun update()
    {
        ...
        val formBody: RequestBody = MultipartBody.Builder()
                ...
                .addFormDataPart("name", editName?.text.toString())
                .addFormDataPart("username", UserShow?.text.toString())
                .addFormDataPart("email", editEmail?.text.toString())
                .addFormDataPart("userBirthday", editBirthday?.text.toString())
                .addFormDataPart("phone", editPhone?.text.toString())
                .addFormDataPart("address", editAddress?.text.toString())
                .addFormDataPart("gender", if (editradioWoman!!.isChecked) "0" else "1")
                .build()
        Log.d("mytest",url)
        val request: Request = Request.Builder()
                .url(url)

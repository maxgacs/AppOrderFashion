                ...
                if (response.isSuccessful) {
                    try {
                        ...
                        if(empStatus == "0"){
                            ...
                            Toast.makeText(applicationContext, "รอการยืนยันจากผู้จัดการ", Toast.LENGTH_LONG).show()
                            ...
                            Toast.makeText(applicationContext, "คำขอการสมัครของคุณถูกปฏิเสธ", Toast.LENGTH_LONG).show()
                        }else{
                            Toast.makeText(applicationContext, "กรุณาสมัครสมาชิก", Toast.LENGTH_LONG).show()
                        }
